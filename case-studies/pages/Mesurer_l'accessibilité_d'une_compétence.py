...
st.header("Mesurer l'accessibilité d'une compétence")
...
st.write("Compétences de la plus accessible à la moins accessible")
...
skill_access = (pa.DataFrame({
                ...
                .loc[lambda x: x.loc[:, "Expériences correspondantes"] == 0]
                )
